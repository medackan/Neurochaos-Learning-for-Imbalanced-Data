...
Code Description: A python code to tune the hyperparameters of CFX+AdaBoost on the Iris dataset.
...
DISCRIMINATION_THRESHOLD = np.arange(0.9, 1, 0.001)
EPSILON = np.arange(0.01, 0.49, 0.1)
